...
class Connector
{
    ...
    const ERROR_CODE_INVALID_TRADING_PAIR                     = 34;
    const ERROR_CODE_INVALID_CURRENCY                         = 35;
    ...
    const ERROR_CODE_ORDER_NOT_POSSIBLE_FOR_TRADING_PAIR     = 58;
    ...
    const SHOW_ORDERBOOK_PARAMETER_TRADING_PAIR = 'trading_pair'; // string
    ...
    const CREATE_ORDER_PARAMETER_TRADING_PAIR = 'trading_pair'; // string
    ...
    const DELETE_ORDER_PARAMETER_TRADING_PAIR = 'trading_pair'; // string

    // Optional parameters for my orders list
    const SHOW_MY_ORDERS_PARAMETER_TYPE           = 'type'; // string (buy|sell)
    const SHOW_MY_ORDERS_PARAMETER_TRADING_PAIR   = 'trading_pair'; // string
    ...
    const EXECUTE_TRADE_PARAMETER_TRADING_PAIR = 'trading_pair'; // string

    // Optional parameters for my trade list
    const SHOW_MY_TRADES_PARAMETER_TYPE           = 'type'; // string (buy|sell)
    const SHOW_MY_TRADES_PARAMETER_TRADING_PAIR   = 'trading_pair'; // string
    ...
    const SHOW_PUBLIC_TRADE_HISTORY_PARAMETER_TRADING_PAIR = 'trading_pair'; // string
    ...
    const SHOW_ACCOUNT_LEDGER_PARAMETER_CURRENCY       = 'currency'; // string

    // Mandatory parameters for show orderbook compact.
    const SHOW_ORDER_BOOK_COMPACT_PARAMETER_TRADING_PAIR = 'trading_pair'; // string

    // Mandatory parameters for show rates.
    const SHOW_RATES_PARAMETER_TRADING_PAIR = 'trading_pair'; // string
    ...
    const MIN_TRUST_LEVEL_PLATIN = 'platin';
    ...
    const TRADING_PAIR_BTCEUR = 'btceur';
    const TRADING_PAIR_BCHEUR = 'bcheur';
    const TRADING_PAIR_ETHEUR = 'etheur';
    ...
    protected $method_settings = array(
        self::METHOD_SHOW_ORDERBOOK            => array(
            ...
            'parameters'  => array(
                ...
                self::SHOW_ORDERBOOK_PARAMETER_TRADING_PAIR,
            ),
        ),
        self::METHOD_CREATE_ORDER              => array(
            ...
            'parameters'  => array(
                ...
                self::CREATE_ORDER_PARAMETER_TRADING_PAIR,
            ),
        ),
        ...
        self::METHOD_EXECUTE_TRADE             => array(
            ...
            'parameters'  => array(
                ...
                self::EXECUTE_TRADE_PARAMETER_TRADING_PAIR,
            ),
        ...
        self::METHOD_SHOW_PUBLIC_TRADE_HISTORY => array(
            ...
            'subentity'   => 'history',
            'parameters'  => array(
                self::SHOW_PUBLIC_TRADE_HISTORY_PARAMETER_TRADING_PAIR,
            ),
        ),
        self::METHOD_SHOW_ORDERBOOK_COMPACT    => array(
            ...
            'subentity'   => 'compact',
            'parameters'  => array(
                self::SHOW_ORDER_BOOK_COMPACT_PARAMETER_TRADING_PAIR,
            ),
        ),
        self::METHOD_SHOW_RATES                => array(
            ...
            'entity'      => 'rates',
            'parameters'  => array(
                self::SHOW_RATES_PARAMETER_TRADING_PAIR,
            ),
        ),
        self::METHOD_SHOW_ACCOUNT_LEDGER       => array(
            ...
            'subentity'   => 'ledger',
            'parameters'  => array(
                self::SHOW_ACCOUNT_LEDGER_PARAMETER_CURRENCY,
            ),
        ),
    );
    ...
    public function doRequest($api_method, array $parameters = array())
    {
        ...
        if (TRUE === isset($this->method_settings[$api_method]['trading_pair'])
            && TRUE === isset($parameters[$this->method_settings[$api_method]['trading_pair']])
        )
        {
            $trading_pair = '/' . $parameters[$this->method_settings[$api_method]['trading_pair']];
            unset($parameters[$this->method_settings[$api_method]['trading_pair']]);
        }
        ...
        $post_parameters = ksort_recursive_v2($post_parameters);
        ...
        $uri                                     = $this->options['uri'] . 'v' . $this->options['api_version'] . '/' . $this->method_settings[$api_method]['entity'] . $id . $trading_pair . $subentity . $prepared_get_parameters;
    ...
    public static function parseHttpHeaders($header)
    {
        ...
        foreach ($fields as $field)
        {
            ...
            {
                $match[1] = preg_replace_callback('/(?<=^|[\x09\x20\x2D])./', function(array $matches) {
 ...
 * @return array
 */
if (!function_exists('ksort_recursive_v2'))
{
    function ksort_recursive_v2(array $values = array())
    {
        foreach ($values as $index => $value)
        {
            if (TRUE === is_array($value))
            {
                $value          = ksort_recursive_v2($value);
                $values[$index] = $value;
            }
        }
...
if (!function_exists('strtoupper_match_v2'))
{
    function strtoupper_match_v2(array $matches)
    {
        return strtoupper($matches[0]);
    }
}
